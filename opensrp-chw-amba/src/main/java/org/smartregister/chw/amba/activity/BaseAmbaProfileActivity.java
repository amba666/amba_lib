...
import org.smartregister.chw.amba.custom_views.BaseAmbaFloatingMenu;
import org.smartregister.chw.amba.dao.AmbaDao;
import org.smartregister.chw.amba.domain.MemberObject;
import org.smartregister.chw.amba.interactor.BaseAmbaProfileInteractor;
...
public class BaseAmbaProfileActivity extends BaseProfileActivity implements AmbaProfileContract.View, AmbaProfileContract.InteractorCallBack {
    protected MemberObject memberObject;
    protected AmbaProfileContract.Presenter profilePresenter;
    protected CircleImageView imageView;
    protected TextView textViewName;
    protected TextView textViewGender;
    protected TextView textViewLocation;
    protected TextView textViewUniqueID;
    protected TextView textViewRecordAmba;
    ...
    protected RelativeLayout rlAmbaPositiveDate;
    ...
    protected BaseAmbaFloatingMenu baseAmbaFloatingMenu;

    public static void startProfileActivity(Activity activity, String baseEntityId) {
        Intent intent = new Intent(activity, BaseAmbaProfileActivity.class);
    ...
    protected void onCreation() {
        setContentView(R.layout.activity_amba_profile);
        ...
        toolbar.setNavigationOnClickListener(v -> BaseAmbaProfileActivity.this.finish());
        ...
        rlAmbaPositiveDate = findViewById(R.id.rlAmbaPositiveDate);
        ...
        textViewRecordAmba = findViewById(R.id.textview_record_amba);
        ...
        rlAmbaPositiveDate.setOnClickListener(this);
        textViewRecordAmba.setOnClickListener(this);
        textViewRecordAnc.setOnClickListener(this);
        textViewUndo.setOnClickListener(this);

        imageRenderHelper = new ImageRenderHelper(this);
        memberObject = AmbaDao.getMember(baseEntityId);
        initializePresenter();
    ...
    protected void initializePresenter() {
        ...
        profilePresenter = new BaseAmbaProfilePresenter(this, new BaseAmbaProfileInteractor(), memberObject);
        fetchProfileData();
    ...
    public void initializeFloatingMenu() {
        if (StringUtils.isNotBlank(memberObject.getPhoneNumber())) {
            baseAmbaFloatingMenu = new BaseAmbaFloatingMenu(this, memberObject);
            baseAmbaFloatingMenu.setGravity(Gravity.BOTTOM | Gravity.RIGHT);
            LinearLayout.LayoutParams linearLayoutParams = new LinearLayout.LayoutParams(
                    LinearLayout.LayoutParams.MATCH_PARENT,
                    LinearLayout.LayoutParams.MATCH_PARENT);
            addContentView(baseAmbaFloatingMenu, linearLayoutParams);
        }
    }

    @Override
    public void hideView() {
        textViewRecordAmba.setVisibility(View.GONE);
    }
    ...
    public void setProfileViewWithData() {
        ...
        textViewGender.setText(AmbaUtil.getGenderTranslated(this, memberObject.getGender()));
        ...
        if (StringUtils.isNotBlank(memberObject.getFamilyHead()) && memberObject.getFamilyHead().equals(memberObject.getBaseEntityId())) {
            findViewById(R.id.family_amba_head).setVisibility(View.VISIBLE);
        }
        if (StringUtils.isNotBlank(memberObject.getPrimaryCareGiver()) && memberObject.getPrimaryCareGiver().equals(memberObject.getBaseEntityId())) {
            findViewById(R.id.primary_amba_caregiver).setVisibility(View.VISIBLE);
        }
        if (memberObject.getAmbaTestDate() != null) {
            textview_positive_date.setText(getString(R.string.amba_positive) + " " + formatTime(memberObject.getAmbaTestDate()));
        }
    }

    @Override
    public void setOverDueColor() {
        textViewRecordAmba.setBackground(getResources().getDrawable(R.drawable.record_btn_selector_overdue));
    }
    ...
    public void refreshUpComingServicesStatus(String service, AlertStatus status, Date date) {
        ...
        if (status == AlertStatus.upcoming) {
            tvUpComingServices.setText(AmbaUtil.fromHtml(getString(R.string.vaccine_service_upcoming, service, dateFormat.format(date))));
        } else {
            tvUpComingServices.setText(AmbaUtil.fromHtml(getString(R.string.vaccine_service_due, service, dateFormat.format(date))));
        }
    }
    ...
    public void refreshFamilyStatus(AlertStatus status) {
        ...
        if (status == AlertStatus.complete) {
            ...
            tvFamilyStatus.setText(AmbaUtil.fromHtml(getString(R.string.family_has_service_overdue)));
        }
    }
