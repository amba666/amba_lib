package org.smartregister.chw.amba;
...
public class AmbaLibrary {
    private static AmbaLibrary instance;
    ...
    public static void init(Context context, Repository repository, int applicationVersion, int databaseVersion) {
        if (instance == null) {
            instance = new AmbaLibrary(context, repository, applicationVersion, databaseVersion);
        }
    }

    public static AmbaLibrary getInstance() {
        if (instance == null) {
    ...
    private AmbaLibrary(Context contextArg, Repository repositoryArg, int applicationVersion, int databaseVersion) {
