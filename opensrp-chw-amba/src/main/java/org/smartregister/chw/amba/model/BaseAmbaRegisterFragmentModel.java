...
import org.smartregister.chw.amba.util.ConfigHelper;
...
public class BaseAmbaRegisterFragmentModel implements AmbaRegisterFragmentContract.Model {

    @Override
    public RegisterConfiguration defaultRegisterConfiguration() {
        return ConfigHelper.defaultRegisterConfiguration(AmbaLibrary.getInstance().context().applicationContext());
    }
