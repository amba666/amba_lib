...
import org.smartregister.provider.AmbaRegisterProvider;
...
public class BaseAmbaRegisterFragment extends BaseRegisterFragment implements AmbaRegisterFragmentContract.View {
    public static final String CLICK_VIEW_NORMAL = "click_view_normal";
    public static final String FOLLOW_UP_VISIT = "follow_up_visit";

    @Override
    public void initializeAdapter(Set<View> visibleColumns) {
        AmbaRegisterProvider ambaRegisterProvider = new AmbaRegisterProvider(getActivity(), paginationViewHandler, registerActionHandler, visibleColumns);
        clientAdapter = new RecyclerViewPaginatedAdapter(null, ambaRegisterProvider, context().commonrepository(this.tablename));
    ...
    public void setupViews(android.view.View view) {
        ...
        if (titleView != null) {
            ...
            titleView.setText(getString(R.string.amba));
            titleView.setFontVariant(FontVariant.REGULAR);
        }
    }

    @Override
    public AmbaRegisterFragmentContract.Presenter presenter() {
        return (AmbaRegisterFragmentContract.Presenter) presenter;
    }
    ...
    protected void initializePresenter() {
        ...
        presenter = new BaseAmbaRegisterFragmentPresenter(this, new BaseAmbaRegisterFragmentModel(), null);
    }
...
//        start forms here if the module requires registration
    ...
    protected void openProfile(String baseEntityId) {
        BaseAmbaProfileActivity.startProfileActivity(getActivity(), baseEntityId);
    }
